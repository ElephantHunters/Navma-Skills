...
These skills are installable into any Claude Project. Once uploaded to Project Knowledge, they activate automatically in every conversation — no re-explaining, no re-teaching.
...
2. Open your Claude Project
3. Go to the **Files** section in the right sidebar (Project Knowledge)
4. Click `+` and upload the `.md` file
5. Done — the skill is active in every new conversation in that project
...
- `harness-first.md`
- `context-loop.md`
- `silent-fail-check.md`
- `jargon-jail-break.md`

To install the full stack, upload all seven `.md` files at once.
...
Josh's original skills were extracted from the video, adapted, renamed, and packaged into installable Claude `.md` files by Naveen.
